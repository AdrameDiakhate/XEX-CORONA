 ...
 */
final class Version20200318235023 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cas (id INT AUTO_INCREMENT NOT NULL, lieu_id INT NOT NULL, new_case_today INT NOT NULL, total_cases INT NOT NULL, new_death_today INT NOT NULL, total_deaths INT NOT NULL, INDEX IDX_3AD60B6AB213CC (lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sensibilisation (id INT AUTO_INCREMENT NOT NULL, video VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, texte LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
